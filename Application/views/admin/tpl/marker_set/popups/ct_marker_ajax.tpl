    ...
    initAoc = function()
    {
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
            [ [{foreach from=$oxajax.container1 item=aItem key=iKey}]
                ...
                [{/foreach}] ],
            '[{$oViewConf->getAjaxLink()}]cmpid=container1&container=ct_shoplocator_admin_marker_set_edit&synchoxid=[{$oxid}]'
        );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc( 'container2',
            [ [{foreach from=$oxajax.container2 item=aItem key=iKey}]
                ...
                [{assign var="sSep" value=","}]
                [{/foreach}] ],
            '[{$oViewConf->getAjaxLink()}]cmpid=container2&container=ct_shoplocator_admin_marker_set_edit&oxid=[{$oxid}]'
        );
...
<table width="100%">
    ...
    <tr class="edittext">
        <td align="center"><b>[{oxmultilang ident="CT_SHOPLOCATOR_ALL_MARKERS"}]</b></td>
        <td align="center"><b>[{oxmultilang ident="CT_SHOPLOCATOR_SET_MARKERS"}]</b></td>
    </tr>
    <tr>
