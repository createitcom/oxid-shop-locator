...
[{capture assign="ShopLocatorBaseJs"}]
/*------------------------------------------------------------------
Project:	ShopLocator
Version:	1.3
...
closeSrc: "[{$oViewConf->getModuleUrl('ct/shoplocator','out/src/style/closeButton.svg')}]",
offsetTop: 2,
offsetRight: 2,
...
var src = "[{$oConfig->getShopURL()}]/modules/ct/shoplocator/out/src/js/markerclusterer.js";
var src2 = "[{$oConfig->getShopURL()}]/modules/ct/shoplocator/out/src/js/infobubble.js";
...
"street": settings.marker.street,
"city": settings.marker.city,
"zip": settings.marker.zip
},
];
...
[{oxscript|strip add=$ShopLocatorBaseJs}]