...
class_alias($parentClass, 'ct\\shoplocator\\Application\\Model\\MapList_extend_ListModel');
 ...
 */
class MapList extends MapList_extend_ListModel
{
     ...
     * @var string
     */
    protected $_sObjectsInListName = Map::class;
